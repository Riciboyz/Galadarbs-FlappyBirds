...
import { Bird, UserPlus, AlertCircle, ArrowLeft, User, Lock, KeyRound } from "lucide-react"
      ...
      <div className="w-full max-w-md relative z-10">
        <Card className="border-0 shadow-2xl bg-white/90 backdrop-blur-sm overflow-hidden">
          ...
          <CardHeader className="text-center pb-2 pt-6">
            ...
            <CardTitle className="text-3xl font-bold bg-gradient-to-r from-green-600 to-blue-600 bg-clip-text text-transparent">Create Account</CardTitle>
            <CardDescription className="text-gray-600 mt-2">Register to start playing Flappy Bird</CardDescription>
          </CardHeader>
